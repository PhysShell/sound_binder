...
namespace gma.System.Windows
{
    ...
    public class UserActivityHook
    {
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            bool handled = false;
            KeyboardHookStruct MyKeyboardHookStructMy = (KeyboardHookStruct)Marshal.PtrToStructure(lParam, typeof(KeyboardHookStruct));
            Keys keyDataMy = (Keys)MyKeyboardHookStructMy.vkCode;
            KeyEventArgs keyb = new KeyEventArgs(keyDataMy);
            //it was ok and someone listens to events
           // if (SoundBinder.Variables.DisabledMass != null && SoundBinder.Variables.DisabledMass[0] != "")
            //    for (int i = 0; i < SoundBinder.Variables.DisabledMass.Length; i++)
            //    {
            //        if (keyb.KeyCode == (Keys)Enum.Parse(typeof(Keys), SoundBinder.Variables.DisabledMass[i], true))
            //            return 0;
            //    }

            //bool found = false;
            //for (int i = 0; i < SoundBinder.Variables.Keys.Count; i++)
            //{
            //    if (keyb.KeyCode == (Keys)Enum.Parse(typeof(Keys), SoundBinder.Variables.Keys[i], true))
            //    { found = true; break; }
            //}
            //if (!found) return 0;
